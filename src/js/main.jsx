                                            ...
                                            <div className="row">
                                                <div className="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <div className="calculator-text-length">
                                                        Długość tekstu:
                                                        <strong className="calculator-monospace">{this.state.textArea.length}
                                                            znaków
                                                            <br/>
                                                            po zaokrągleniu {this.state.textAreaPages}
                                                            str.
                                                        </strong>
                                                        <span className="minimum-text">(min. 1 str.)</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="chosen-table">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 col-md-12 col-sm-12">
                                                <div className="text-explanation">
                                                    Wpisz swój adres email, podaj dane Twojej firmy i wciśnij ZAMAWIAM, aby otrzymać
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 col-md-12 col-sm-12">
                                                ...
                                                <p className="invoice-info"> poniżej wzór faktury proforma do wysłania mailem </p>
                                            </div>
                                        </div>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-lg-4 col-md-4 col-sm-4">
                                                                    <div className="client-data">
                                                                        dla:<br/>
                                                                        <b>{this.state.company.length === 0 ? "...podaj nazwę firmy..." : this.state.company }</b><br/>
                                                                        <b>{this.state.street.length === 0 ? "...podaj nazwę ulicy..." : this.state.street } {this.state.number} lok. {this.state.locale}</b><br/>
                                                                        <b>NIP: {this.state.nip.length !== 10 ? "...podaj NIP (10 cyfr)..." : this.state.nip }</b>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-4 col-md-4 col-sm-4">
                                                                    <div className="service-data">
                                                                        Usługa:<br/> <b>{this.state.chosenServiceDescripion}</b><br/>
                                                                        ilość stron: <b>{this.state.textAreaPages}</b><br/>
                                                                        cena za stronę: <b>{this.state.pagePrice} zł</b>
                                                                    </div>
                                                                </div>
                                                                <div className="col-lg-4 col-md-4 col-sm-4">
                                                                    <div className="service-prices">
                                                                        Cena netto:<br/>
                                                                        <b>{this.state.chosenServicePrice} zł</b><br/>
                                                                        Cena brutto:<br/>
                                                                        <b>{this.calculateVat(this.state.chosenServicePrice)} zł</b><br/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
